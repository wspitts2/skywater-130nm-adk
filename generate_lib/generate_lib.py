...
lib_read = open(TOP + '/generate_lib/sky130_fd_sc_hd__tt_025C_1v80.lib', 'r').read()
...
with open(TOP + '/generate_lib/sky130_fd_sc_hd__tt_025C_1v80.fixed.lib','w') as write_file:
...
copyfile(TOP + '/generate_lib/sky130_fd_sc_hd__tt_025C_1v80.fixed.lib', TOP + '/generate_db/sky130_fd_sc_hd__tt_025C_1v80.lib')
copyfile(TOP + '/generate_lib/sky130_fd_sc_hd__tt_025C_1v80.fixed.lib', TOP + '/view-standard/stdcells.lib')
